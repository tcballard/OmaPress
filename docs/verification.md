...
- 22 Rust engine regressions pass.
...
GitHub CI passed the loopback HTTP integration test, Qt application/MIME clipboard smoke and installed-bundle checks on the initial PR revision. This local environment restricts socket creation. Real Omarchy keyboard/accessibility, live theme changes, X paste and RSS reader integration remain Tom’s acceptance tasks. Domain ownership/spelling and real article import remain pending user-supplied material.
