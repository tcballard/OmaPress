...
dest=root/'dist';dest.mkdir(exist_ok=True);bundle=dest/f'pressroom-{version}-linux-x86_64'
if bundle.exists():shutil.rmtree(bundle)
(bundle/'bin').mkdir(parents=True)
for src,name in [(root/'target/release/pressroom','pressroom'),(root/'build/desktop/pressroom-desktop','pressroom-desktop')]:
